...
const INFRA_FILES = [
  ...
  "wlroots-0001-drm-image-descriptions-on-the-liftoff-interface.patch",
  "wlroots-0002-scene-only-a-real-mode-change-blocks-direct-scanout.patch",
  "wlroots-0003-scene-offload-the-top-surface-to-an-output-layer.patch",
  "wlroots-0004-drm-cap-the-overlay-planes-given-to-libliftoff.patch",
