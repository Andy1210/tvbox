...
| [shell/backup.js](shell/backup.js)                                                                  | Encrypted settings backup/restore (phone page: [shell/pairing/backup.js](shell/pairing/backup.js)). Carries config, manifests, per-app `storage` data, app-declared files (`backup.paths`/`backup.state`) and the **list of installed app ids**; what it cannot carry is re-acquired by reconcile.js.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
