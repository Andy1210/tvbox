...
const DYNAMIC = [
  ...
  "firetvir.key.",
  "fileserver.err.",
]; // built at runtime (Clock, Ambient weather, Settings categories, remap actions, power options, keyboard-layout names, IR blaster actions/backends, Fire TV IR key names, the box's file-server error codes)
